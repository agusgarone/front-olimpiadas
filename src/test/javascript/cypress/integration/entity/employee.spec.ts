...
describe('Employee e2e test', () => {
  ...
  it('should create an instance of Employee', () => {
    ...
    cy.get(`[data-cy="firstName"]`).type('Virginia').should('have.value', 'Virginia');

    cy.get(`[data-cy="lastName"]`).type('Linares').should('have.value', 'Linares');

    cy.get(`[data-cy="email"]`).type('Catalina.Barrera@yahoo.com').should('have.value', 'Catalina.Barrera@yahoo.com');

    cy.get(`[data-cy="phoneNumber"]`).type('Gestionado Artesanal orquestar').should('have.value', 'Gestionado Artesanal orquestar');

    cy.get(`[data-cy="hireDate"]`).type('2021-09-25T19:38').should('have.value', '2021-09-25T19:38');
