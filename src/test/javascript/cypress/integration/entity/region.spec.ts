...
describe('Region e2e test', () => {
  ...
  it('should load details Region page', function () {
  ...
  it('should load edit Region page', function () {
    cy.visit(regionPageUrl);
    cy.wait('@entitiesRequest').then(({ response }) => {
      if (response.body.length === 0) {
        this.skip();
  ...
  it('should create an instance of Region', () => {
    ...
    cy.get(`[data-cy="regionName"]`).type('extranet sensible inteligencia').should('have.value', 'extranet sensible inteligencia');
  ...
  it('should delete last instance of Region', function () {
