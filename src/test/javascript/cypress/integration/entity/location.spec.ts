...
describe('Location e2e test', () => {
  ...
  it('should create an instance of Location', () => {
    ...
    cy.get(`[data-cy="postalCode"]`).type('de Borders').should('have.value', 'de Borders');

    cy.get(`[data-cy="city"]`).type('Móstoles Anitaberg').should('have.value', 'Móstoles Anitaberg');

    cy.get(`[data-cy="stateProvince"]`).type('Morado dot-com').should('have.value', 'Morado dot-com');
