...
describe('JobHistory e2e test', () => {
  ...
  it('should create an instance of JobHistory', () => {
    ...
    cy.get(`[data-cy="startDate"]`).type('2021-09-26T18:21').should('have.value', '2021-09-26T18:21');

    cy.get(`[data-cy="endDate"]`).type('2021-09-26T08:29').should('have.value', '2021-09-26T08:29');
