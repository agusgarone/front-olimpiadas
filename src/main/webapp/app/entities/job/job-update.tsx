  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="olimpiadasApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="job-employee" name="employeeId" data-cy="employee" label="Employee" type="select">
                <option value="" key="0" />
                {employees
