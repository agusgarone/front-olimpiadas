  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="olimpiadasApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="job-history-job" name="jobId" data-cy="job" label="Job" type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField id="job-history-department" name="departmentId" data-cy="department" label="Department" type="select">
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField id="job-history-employee" name="employeeId" data-cy="employee" label="Employee" type="select">
                <option value="" key="0" />
                {employees
