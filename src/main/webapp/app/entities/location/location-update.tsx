  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="olimpiadasApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="location-country" name="countryId" data-cy="country" label="Country" type="select">
                <option value="" key="0" />
                {countries
