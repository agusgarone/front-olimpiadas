  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="olimpiadasApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="country-region" name="regionId" data-cy="region" label="Region" type="select">
                <option value="" key="0" />
                {regions
