  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="olimpiadasApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="department-location" name="locationId" data-cy="location" label="Location" type="select">
                <option value="" key="0" />
                {locations
